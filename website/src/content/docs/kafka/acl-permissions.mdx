...
```bash
kubectl create secret generic klag-kafka-creds \
  --from-literal=jaas-config="org.apache.kafka.common.security.plain.PlainLoginModule required username='<api-key>' password='<api-secret>';"
